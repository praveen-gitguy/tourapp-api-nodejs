    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(true); // if ((res.data.status = 'success')) location.assign('/login');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/users/updatepassword' : 'http://127.0.0.1:3000/api/users/updateme';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe("pk_test_51GzZkYCgIiW5wWot7iYDXtRydPP10iaRsAkY9mnrX7wrgd9d01cAeovG1Kj6TbfgXT67o5zoq2NMl8nCOKzo5DRD00r4tRaSku");
